<div align="center">
  ...
  <div style="background: #0f172a; border: 1px solid rgba(0, 234, 255, 0.15); border-radius: 12px; padding: 30px; width: 90%; max-width: 800px; box-shadow: 0 20px 50px rgba(0,0,0,0.5);">
