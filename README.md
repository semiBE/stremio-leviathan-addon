...
<div align="center">
 ...
 <span class="notranslate" translate="no">𝗟𝗘𝗩𝗜𝗔𝗧𝗛𝗔𝗡</span>
    
   <br>
    
   <span style="font-size: 1.5rem; letter-spacing: 2px; font-weight: normal;
                 text-shadow: 0 0 10px rgba(0, 234, 255, 0.8);
                 -webkit-text-fill-color: #00eaff; color: #00eaff;">
